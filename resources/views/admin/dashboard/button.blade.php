...
<div class="container grid px-6 mx-auto">
    ...
    >
      ...
      <div class="mt-4">
        <button
          class="px-6 py-4 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
        >
          Larger button
        </button>
      </div>
